...
try:
    ...
    raise AnsibleError("Cliconf Plugin [ config_management_plane ]: Dependency not satisfied")
...
class Cliconf(CliconfBase):
    """
        Examples:
            ...
            https://github.com/ansible/ansible/blob/devel/lib/ansible/plugins/cliconf/junos.py
    """
    raise AnsibleError("Cliconf Plugin [ config_management_plane ]:  Not implemented")