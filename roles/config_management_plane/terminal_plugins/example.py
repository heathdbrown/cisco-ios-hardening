...
try:
    ...
    raise AnsibleError("Terminal Plugin [ config_management_plane ]: Dependency not satisfied")
...
class TerminalModule(TerminalBase):
    """
        Examples:
            ...
            https://github.com/ansible/ansible/blob/devel/lib/ansible/plugins/terminal/junos.py
    """
    raise AnsibleError("Terminal Plugin [ config_management_plane ]: Not implemented")