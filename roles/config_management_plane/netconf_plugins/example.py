...
try:
    ...
    raise AnsibleError("Netconf Plugin [ config_management_plane ]: Dependency not satisfied")
...
class Netconf(NetconfBase):
    """
        Examples:
            ...
            https://github.com/ansible/ansible/blob/devel/lib/ansible/plugins/netconf/junos.py
    """
    raise AnsibleError("Netconf Plugin [ config_management_plane ]: Not implemented")